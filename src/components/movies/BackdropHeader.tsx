...
export function BackdropHeader({ backdropPath, posterPath }: BackdropHeaderProps) {
  ...
  return (
    <View>
      {backdropPath ? (
        <Image
          source={{ uri: buildBackdropUrl(backdropPath, 'large') }}
      ...
      <View style={styles.posterRow}>
        <View style={[styles.posterWrapper, Platform.OS === 'ios' ? styles.iosShadow : styles.androidShadow]}>
          {posterPath ? (
            <Image
              source={{ uri: buildPosterUrl(posterPath, 'medium') }}
